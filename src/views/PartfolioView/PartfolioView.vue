<template>
  <div class="py-[150px]">
    <div class="container mx-auto">
      <h2 class="text-[28px] font-medium font-[Roboto]">Recent Projects</h2>
      <div class="flex justify-between items-center">
        <h2 class="text-[64px] font-bold font-[Roboto]">My Partfolio</h2>
        <div
          class="flex items-center justify-between bg-[#E62872] hover:bg-[#542cf2] duration-200 p-[22px] rounded-lg w-[230px]"
        >
          <img src="@/img/Vector.svg" alt="ball logo" />
      ...
      >
        <div class="w-[500px] h-[600px] flex flex-col rounded-lg shadow-lg">
          <img src="@/img/1project.png" alt="project photo" />
        ...
        <!-- card 2 -->
        <div class="w-[500px] h-[600px] flex flex-col rounded-lg shadow-lg">
          <img src="@/img/2project.png" alt="project photo" />
          <div class="p-7 flex flex-col">
        ...
        <!-- card 3 -->
        <div class="w-[500px] h-[600px] flex flex-col rounded-lg shadow-lg">
          <img src="@/img/3project.png" alt="project photo" />
          <div class="p-7 flex flex-col">
